<?php
		...
		print "<p><b>타이틀 1 :</b>" . $dtitle . "</p>";
		print "<p><b>컨텐츠1 :</b>" . $dcontent . "</p>";
		print "<p><b>위도 1 :</b>" . $dlocLat . "</p>";
		print "<p><b>경도 1 :</b>" . $dlocLng . "</p>";
		print "<p><b>날짜 1 :</b>" . $ddate . "</p>";
		print "<p><b>ID 1 :</b>" . $duserId . "</p>";
		print "<p><b>이름 1 :</b>" . $duserName0 . "</p>";
